...
class CellTypesTab(object):
    ...
    def __init__(self):
        ...
        name_btn.style.button_color = 'tan'
        self.float29 = FloatText(value='0.25', step='0.01', style=style, layout=widget_layout)
        ...
        name_btn.style.button_color = 'lightgreen'
        self.float30 = FloatText(value='5', step='0.1', style=style, layout=widget_layout)
        ...
        name_btn.style.button_color = 'tan'
        self.float31 = FloatText(value='0.5', step='0.1', style=style, layout=widget_layout)
        ...
        name_btn.style.button_color = 'lightgreen'
        self.chemotaxis_substrate1 = Text(value='immunostimulatory factor', disabled=False, style=style, layout=widget_layout_long)
        ...
        name_btn.style.button_color = 'lightgreen'
        self.float33 = FloatText(value='38', step='1', style=style, layout=widget_layout)
        ...
        name_btn = Button(description='substrate', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.text1 = Text(value='immunostimulatory factor', disabled=False, style=style, layout=widget_layout_long)
...
#      ================== <custom_data>, if present ==================
        ...
        name_btn = Button(description='oncoprotein', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float40 = FloatText(value='1.0', step='0.1', style=style, layout=widget_layout)
        units_btn = Button(description='dimensionless', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        ...
        name_btn = Button(description='elastic_coefficient', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        ...
        name_btn = Button(description='kill_rate', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float42 = FloatText(value='0.06667', step='0.01', style=style, layout=widget_layout)
        units_btn = Button(description='1/min', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'lightgreen'
        ...
        name_btn = Button(description='attachment_lifetime', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.float43 = FloatText(value='60', step='1', style=style, layout=widget_layout)
        units_btn = Button(description='min', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'tan'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'tan'
        ...
        name_btn.style.button_color = 'lightgreen'
        self.float44 = FloatText(value='0.2', step='0.01', style=style, layout=widget_layout)
        units_btn = Button(description='1/min', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'lightgreen'
        ...
        name_btn = Button(description='oncoprotein_saturation', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.float45 = FloatText(value='2.0', step='0.1', style=style, layout=widget_layout)
        units_btn = Button(description='dimensionless', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'tan'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'tan'
        ...
        name_btn = Button(description='oncoprotein_threshold', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float46 = FloatText(value='0.5', step='0.1', style=style, layout=widget_layout)
        units_btn = Button(description='dimensionless', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'lightgreen'
        ...
        name_btn.style.button_color = 'tan'
        self.float47 = FloatText(value='18.0', step='1', style=style, layout=widget_layout)
        ...
        name_btn = Button(description='min_attachment_distance', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float48 = FloatText(value='14.0', step='1', style=style, layout=widget_layout)
        units_btn = Button(description='micron', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'lightgreen'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'lightgreen'
